...
class CNNencoder_drop(nn.Module):
    def __init__(self, in_c, out_c):
        super().__init__()
        self.model = nn.Sequential(
...
class Cartoon_Discriminator(nn.Module):
    def __init__(self, in_channels=3):
        super().__init__()
        self.pooling = nn.MaxPool2d(kernel_size=2)
        self.conv1_1 = CNNencoder(in_channels, 16)
        self.conv1_2 = CNNencoder_drop(16, 16)
        self.conv2_1 = CNNencoder(16, 16*2)
        self.conv2_2 = CNNencoder_drop(16*2, 16*2)
        self.conv3_1 = CNNencoder(16*2, 16*4)
        self.conv3_2 = CNNencoder_drop(16*4, 16*4)
        self.conv4_1 = CNNencoder(16*4, 16*8)
        self.conv4_2 = CNNencoder_drop(16*8, 16*8)
        self.conv5_1 = CNNencoder(16*8, 16*16)
