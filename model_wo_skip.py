...
class Cartoon_Decoder(nn.Module):
    def __init__(self):
        ...
        self.concat1 = CNNencoder_gn(512, 128)
        self.convup1 = CNNencoder_gn(128, 128)
        self.concat2 = CNNencoder_gn(256, 64)
        self.convup2 = CNNencoder_gn(64, 64)
        self.concat3 = CNNencoder_gn(128, 32)
        self.convup3 = CNNencoder_gn(32, 32)
        self.concat4 = CNNencoder_gn(64, 16)
        self.convup4 = CNNencoder_gn(16, 16)
        self.concat5 = CNNencoder_ln(32, 3)
