...
def main():
    ...
    for epoch in range(epoch):
        ...
        createFolder('/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d' % epoch)
        ...
        with torch.no_grad():
            ...
            plt.imshow(out111)
            plt.savefig('/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/out1.png' % epoch, bbox_inches='tight',
                        pad_inches=0)
            plt.imshow(out222)
            plt.savefig('/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/out2.png' % epoch, bbox_inches='tight',
                        pad_inches=0)
            plt.imshow(out333)
            plt.savefig('/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/out3.png' % epoch, bbox_inches='tight',
                        pad_inches=0)
        ...
        if epoch % 10 == 0:
            ...
            torch.save(Cartoon_Encoder.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/Cartoon_Encoder.pth' % epoch)
            torch.save(CelebA_Encoder.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/CelebA_Encoder.pth' % epoch)
            torch.save(Bottleneck.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/Bottleneck.pth' % epoch)
            torch.save(Cartoon_Decoder.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/Cartoon_Decoder.pth' % epoch)
            torch.save(CelebA_Decoder.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/CelebA_Decoder.pth' % epoch)
            torch.save(Cartoon_Discriminator.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/Cartoon_Discriminator.pth' % epoch)
            torch.save(CelebA_Discriminator.state_dict(), '/home/mjy/AvatarGAN/generated_img/Gaussian_norm/epoch_%d/CelebA_Discriminator.pth' % epoch)
